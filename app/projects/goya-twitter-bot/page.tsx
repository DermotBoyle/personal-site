			...
			<section className='flex flex-col md:flex-row w-[70vw] pt-6'>
				...
				<div className='w-[70vw] md:w-[60vw]'>
					...
					<p className='md:mt-4 '>
						...
						It is built with AWS using Node, Typescript and OpenAI. It has an event driven architecture. An EventBridge routine
						is run each morning triggering lambdas that generate a new tweet with content generated by AI related to works of Goya.
						S3 is used as storage for the images and dynamoDB for the persistent state of the app.
						The tweet is then posted to Twitter using the Twitter v2 API.
					</p>
					<p className='mt-4'>
