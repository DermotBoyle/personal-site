...
const DocumentsPage = () => {
  ...
  return (
    <main
      className={`flex min-h-screen flex-col items-center justify-between px-24 py-12`}
    >
      <section>
        {staticProjectData &&
            ...
            <AnimatedCard>
              ...
              <div>
                <div className="absolute top-4 left-4">
                  ...
                  <p className="text-left text-orange-accent font-medium show-text-delay">
                ...
                <div>
                  <Link
                    href={mappedItem.link ?? "/"}
                    className="absolute text-orange-accent font-medium bottom-4 right-4 show-text-delay hover:underline flex mr-0"
                  >
                    Find out more
                    <svg
