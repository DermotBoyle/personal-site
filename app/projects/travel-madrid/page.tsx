    ...
    <main className='flex min-h-screen flex-col items-center px-24'>
      ...
      <section className='flex flex-col md:flex-row w-[70vw] pt-6'>
        <div className='w-[95%] md:w-[50%] mb-8 md:mb-24'>
          <div className='flex flex-col md:flex-row mb-8'>
            ...
            <p className='md:hidden'>
              Swift, SwiftUI, UIKit, MapKit, CoreLocation, CoreData
            </p>
          </div>
        ...
        <div className='w-[70vw] md:w-[60vw]'>
          ...
          <p className='md:mt-4 '>
            Travel Madrid is a native iOS travel app that allows users to plan
            their journeys using public transport.
          </p>
          <p className='mt-4'>
          ...
          <p className='mt-4'>
            Real-time data is supplied by the EMT open api (official transport
            of Madrid live data)
          </p>
        </div>
      </section>
      ...
      <section className='w-[70vw] md:pt-6 pt-14'>
        ...
        <p>
          The main logo and images used in the app are generated using the
          Midjourney AI app. The idea is to have a beautiful and interesting
          image for each of the main neighbourhoods of Madrid.
        </p>
      </section>
